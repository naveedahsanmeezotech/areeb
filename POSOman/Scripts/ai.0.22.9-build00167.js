...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        var dateTime = (function () {
            ...
            DateTime.UtcNow.AddHours(5) = (window.performance && window.performance.now) ?
                function () {
    ...
    (function (ApplicationInsights) {
        ...
        var AjaxMonitor = (function () {
            ...
            AjaxMonitor.prototype.sendHandler = function (xhr, content) {
                xhr.ajaxData.requestSentTime = ApplicationInsights.DateTime.UtcNow.AddHours(5)();
            ...
            AjaxMonitor.prototype.onAjaxComplete = function (xhr) {
                xhr.ajaxData.responseFinishedTime = ApplicationInsights.DateTime.UtcNow.AddHours(5)();
